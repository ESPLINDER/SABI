...
class DietaVegetariana extends StatefulWidget {
  const DietaVegetariana({Key? key}) : super(key: key);

  @override
  State<DietaVegetariana> createState() => _DietaVegetarianaState();
}

class _DietaVegetarianaState extends State<DietaVegetariana> {
  String selectedFilter = 'Relevancia';
  List<Recipe> recipes = [
    Recipe(name: 'Ensalada de Quinoa', icon: Icons.food_bank),
    Recipe(name: 'Tacos de Lentejas', icon: Icons.fastfood),
    Recipe(name: 'Sopa de Verduras', icon: Icons.soup_kitchen),
    Recipe(name: 'Batido Verde', icon: Icons.local_drink),
    Recipe(name: 'Hamburguesas de Garbanzos', icon: Icons.local_pizza),
    Recipe(name: 'Pasta Primavera', icon: Icons.food_bank),
  ];
