...
class DietaPaleo extends StatefulWidget {
  const DietaPaleo({Key? key}) : super(key: key);

  @override
  State<DietaPaleo> createState() => _DietaPaleoState();
}

class _DietaPaleoState extends State<DietaPaleo> {
  String selectedFilter = 'Relevancia';
  List<Recipe> recipes = [
    Recipe(name: 'Ensalada de Pollo a la Parrilla', icon: Icons.food_bank),
    Recipe(name: 'Tacos de Lechuga', icon: Icons.fastfood),
    Recipe(name: 'Sopa de Calabaza', icon: Icons.soup_kitchen),
    Recipe(name: 'Batido de Plátano y Almendras', icon: Icons.local_drink),
    Recipe(name: 'Pescado al Horno con Verduras', icon: Icons.lunch_dining),
    Recipe(name: 'Burgers de Carne de Res', icon: Icons.local_pizza),
  ];
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              ...
              '• Promueve una alimentación natural y sin procesar\n'
              '• Ayuda a mejorar la salud metabólica\n'
              '• Puede contribuir a la pérdida de peso y a una mejor digestión',
              style: TextStyle(
                color: Colors.white,
                fontSize: 18,
