...
class DietaCetogenica extends StatefulWidget {
  const DietaCetogenica({Key? key}) : super(key: key);

  @override
  State<DietaCetogenica> createState() => _DietaCetogenicaState();
}

class _DietaCetogenicaState extends State<DietaCetogenica> {
  String selectedFilter = 'Relevancia';
  List<Recipe> recipes = [
    Recipe(name: 'Ensalada César con Pollo', icon: Icons.food_bank),
    Recipe(name: 'Tortilla de Espinacas', icon: Icons.fastfood),
    Recipe(name: 'Sopa de Champiñones', icon: Icons.soup_kitchen),
    Recipe(name: 'Batido de Aguacate', icon: Icons.local_drink),
    Recipe(name: 'Pizza de Coliflor', icon: Icons.local_pizza),
    Recipe(name: 'Pasta de Calabacín', icon: Icons.no_drinks),
  ];
        ...
        children: [
          ...
          Container(
            ...
            child: const Text(
              ...
              '• Promueve la pérdida de peso rápida\n'
