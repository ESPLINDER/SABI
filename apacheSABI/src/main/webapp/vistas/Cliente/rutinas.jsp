            ...
            <div class="col-md-12 align-items-center text-center row">
                ...
                <div class="col-md-4 ms-auto">
                    <button class="nueva btn">
                        <a style="color: white;" href="<%=contextPath%>/vistas/Cliente/formRutina.jsp">+ Crear nueva rutina</a>
                    </button>
                </div>
            </div>
                ...
                <div class="rutina mt-4 row">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="row my-auto mx-auto pt-1">
                            <button class="asignar btn btn-success col-md-4 mx-auto" data-bs-toggle="modal" data-bs-target="#clientes">Usar rutina</button>
                        </div>
                    </div>
                </div>
            </div>
